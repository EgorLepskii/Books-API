...
class SimilarTest extends \Tests\TestCase implements Constants
{
     ...
     */
    public function testSimilarPrice(): void
    {
        $flag = false;
        ...
        foreach ($similarBooks->toArray() as $item) {
            $this->assertNotEquals($item['name'], $bookWithIncorrectPriceLeft->getName());
            $this->assertNotEquals($item['name'], $bookWithIncorrectPriceRight->getName());

            if ($item['name'] == $bookWithCorrectPrice->getName()) {
                $flag = true;
            }
        }
     ...
     */
    public function testSimilarGenre(): void
    {
        ...
        foreach ($similarBooks->toArray() as $item) {
            ...
            if ($item['name'] == $correctBook->getName()) {
                $flag = true;
            }
        }
