...
class SearchControllerTest extends \Tests\TestCase implements Constants
{
     ...
     */
    public function test_correct(array $params): void
    {
        $this->get(route('bookSearch.index', $params))->assertSee($this->book->getName());
    }

    /**
     * @return array{all_fields: array<int, array{name: string, authors: string, leftPrice: int, rightPrice: int}>, name_substr: array<int, array{name: string, authors: string, leftPrice: int, rightPrice: int}>, other_register: array<int, array{name: string, authors: string, leftPrice: int, rightPrice: int}>}
     */
     ...
     * @param        array<string, int>|array<string, string> $params
     */
    public function test_incorrect(array $params): void
    {
        $this->get(route('bookSearch.index', $params))->assertDontSee($this->book->getName());
    }

    /**
     * @return array{name_substring_skipped: array<int, array{name: string, authors: string, leftPrice: int, rightPrice: int}>, authors_substring_skipped: array<int, array{name: string, authors: string, leftPrice: int, rightPrice: int}>}
     */
