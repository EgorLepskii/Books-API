...
class ValidationCreateTest extends \Tests\TestCase implements Constants
{
     ...
     * @param        array<string, float>|array<string, int>|array<string, string> $data
     */
    ...
    /**
     * @return array<int, array<int, array{name: string, annotation: string, authors: string, price: float|int}>>
     */
    public function createBookCorrectDataProvider(): array
    {
     ...
     * @param        array<string, float>|array<string, int>|array<string, null>|array<string, string> $data
     */
    ...
    /**
     * @return array{empty_name: array<int, array{name: string, annotation: string, authors: string, price: float, genreId: null}>, empty_annotation: array<int, array{name: string, annotation: string, authors: string, price: float, genreId: null}>, empty_authors: array<int, array{name: string, annotation: string, authors: string, price: float, genreId: null}>, empty_price: array<int, array{name: string, annotation: string, authors: string, price: string, genreId: null}>, empty_genre: array<int, array{name: string, annotation: string, authors: string, price: string, genreId: string}>, incorrect_genre: array<int, array{name: string, annotation: string, authors: string, price: string, genreId: string}>, name_length_exceeded: array<int, array{name: string, annotation: string, authors: string, price: float, genreId: null}>, annotation_length_exceeded: array<int, array{name: string, annotation: string, authors: string, price: float, genreId: null}>, authors_length_exceeded: array<int, array{name: string, annotation: string, authors: string, price: float, genreId: null}>, max_price_exceeded: array<int, array{name: string, annotation: string, authors: string, price: float, genreId: null}>, price_less_than_min_price_value: array<int, array{name: string, annotation: string, authors: string, price: int, genreId: null}>}
     */
